		...
		?>
			<div class="hero-unit box effect2">
				...
				<p>
					...
					<?php echo get_custom_excerpt(360); ?> <a href="<?php the_permalink(); ?>" style="color:#666;">[...]</a>
				</p>
				<p>
					<a href="<?php the_permalink(); ?>" class="btn btn-primary btn-large">Read more &rsaquo;</a>
				</p>
			</div>
		<?php
			endwhile;
			...
			if ( have_posts() ) : ?>
				<div class="clearfix"></div>
					...
					<?php while ( have_posts() ) : the_post(); ?>					
						<!--<div <#php post_class("col-md-6"); #-->  <div id="post-<?php the_ID(); ?>">							
							<div class="inneritem">
								...
								<div class="entry-content">
									...
									<?php echo get_custom_excerpt(176); ?> <a href="<?php the_permalink(); ?>">[...]</a>
								</div><!-- .entry-content -->							
								</div>
							</div>
						</div><!-- #boxportfolio-## -->						
