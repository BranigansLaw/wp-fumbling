...
/*********************************************************************************************
GENERATE DYNAMIC OPTIONS CSS for styleoptions
*********************************************************************************************/
function generate_options_css($newdata) {
	...
	/** Capture CSS output **/
	ob_start();
	require($css_dir . 'styleoptions.php');
	$css = ob_get_clean();
	
	/** Write to styleoptions.css file **/
	WP_Filesystem();
	global $wp_filesystem;
	if ( ! $wp_filesystem->put_contents( $aq_uploads_dir . 'styleoptions.css', $css, 0644) ) {
	    return true;
	}
