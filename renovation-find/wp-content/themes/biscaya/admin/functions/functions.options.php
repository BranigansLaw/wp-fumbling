...
$of_options[] = array( 	"name" 		=> "Social Top",
						"desc" 		=> "Enter code for social icons",
						"id" 		=> "header_socialicons",
						"std" 		=> "<li><a href='#' target='_blank'><i class='fa fa-facebook'></i></a></li>
										<li><a href='#' target='_blank'><i class='fa fa-twitter'></i></a></li>",
						"type" 		=> "textarea"
				);
				
$of_options[] = array( 	"name" 		=> "Info Top",
						"desc" 		=> "Enter info on top area",
						"id" 		=> "header_infotoparea",
						"std" 		=> "TEL: +8 737 924 6035 <br/>
...
$of_options[] = array( 	"name" 		=> "Footer Text",
						"desc" 		=> "Copyright Area",
						"id" 		=> "footer_text",
						"std" 		=> "&copy; 2014 Biscaya v2.0 Theme by <a href='http://www.wowthemes.net/premium-themes-templates/' target='blank'>WowThemes.net</a>",
						"type" 		=> "textarea"
				);
...
$of_options[] = array( 	"name" 		=> "Meta Tags",
						"desc" 		=> "Display meta tags in blog (date, author etc)",
						"id" 		=> "switch_metatagsblog",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
						"type" 		=> "switch"
...
$of_options[] = array( 	"name" 		=> "Boxed Layout",
						"desc" 		=> "Enable it if you prefer the boxed layout<br/> Disable it if you prefer the full width layout",
...
$of_options[] = array( 	"name" 		=> "Main Text",
						"desc" 		=> "",
						"id" 		=> "body_font",
						"std" 		=> array(
											'size'  => '13px',
...
$of_options[] = array(  "name" 		=> "",
						"desc" 		=> "Select a google font for body text <br/>(choose 'select font' -1st option - if you do NOT want google font enabled)",
						"id" 		=> "g_select_body",
						"std" 		=> "Open Sans",
						"type" 		=> "select_google_font",
						"preview" 	=> array(
										"text" => "This is a preview text. Like this font? Use it!", //this is the text from preview box
...
$of_options[] = array( 	"name" 		=> "Theme Skin Color",
						"desc" 		=> "Select a predefined skin or create your own below",
						"id" 		=> "alt_stylesheet",
						"std" 		=> "orange.css",
						"type" 		=> "select",
...
$of_options[] = array( 	"name" 		=> "Create your own skin color",
						"desc" 		=> "Pick a color to enable your own color skin (choose 'clear' to disable).",
						"id" 		=> "ownskin_color",
						"std" 		=> "",
						"type" 		=> "color"
				);				
...
$of_options[] = array( "name" 		=> "Portfolio Columns",
						"desc" 		=> "3 = Four Columns<br/> 4 = Three Columns<br/> 6 = Two Columns<br/>12 = Single Column",
						"id" 		=> "portfoliocolumns",
						"std" 		=> "4",
						"type" 		=> "select",
						"options" 	=> array('12' => '12', '3' => '3', '4' => '4', '6' => '6'));
