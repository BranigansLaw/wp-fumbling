...
if($error == true){
	echo '<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button>' . __('All fields are required.', 'tdwowbiscaya'). '</div>';
}
...
if($error == false){
	...
	echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>' . __('Your message has been sent.', 'tdwowbiscaya'). '</div>';	
